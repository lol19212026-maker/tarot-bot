...
PROMPTS = {
    ...
    2. ВАЖНО ПО ФОРМАТИРОВАНИЮ:
       - Телеграм поддерживает ТОЛЬКО теги <b> и <i>.
       - ЗАПРЕЩЕНО использовать Markdown (###, **, __).
       - ЗАПРЕЩЕНО использовать HTML заголовки (<h1>, <h2>, <h3>).
       - Для заголовков используй только <b>Текст</b>.
    3. Структура ответа:
    ...
    ВАЖНО: Используй ТОЛЬКО HTML теги <b> и <i>. Не используй Markdown или <h3>.
    """
}
